...
ScoreGate nutCracker(25, 200, scoreCallback, DEBUG_LEVEL);
ScoreGate polarBear(26, 500, scoreCallback, DEBUG_LEVEL);
ScoreGate kid(27, 75, scoreCallback, DEBUG_LEVEL);
