$('document').ready(function() {
	...
	$('body').on('click','.game-target-controller', function(){
		$('.game-target').toggleClass('target-on');
	});
	
	$('body').on('click','.white-help-button',function(){
		$('.global-help').show();
	});
	
	$('body').on('click','.global-help-button',function(){
		$('.global-help').show();
	});
	
	$('body').on('click','.global-close-button',function(){
		$('.global-help').fadeOut(400);
	});
	
	$('.terms-controller p').click(function() {
...
String.prototype.randColors = function() {
	...
	//FLASH FOCUS BUG HACK
    function changeFocusAgain(){
    	var elem = document.getElementById("body");
            elem.tabIndex = 0;
            elem.focus();
            elem.blur();
            alert("changeFocusAgain");
    };
