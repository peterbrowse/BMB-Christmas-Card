    			...
    			<div class="view-container">
    				<div class="scene-outter">
						...
						<!-- START GAME OVER STATS-->
    						<div class="global-help-content pre-game-help green-bg">
    									<p class="global-help-intro pre-game-title">You have 120 seconds to score as many points as possible!</p>
										...
										<p class="contactWho">Any problems, email:</p>			
